...
class TestRequest(unittest.TestCase):
    ...
    def test_check_params_mandatory_not_empty(self):
        ...
        req = ApiRequest(event, '0fa8fc8f-b04a-11e6-b8ed-6dda0ca82a80')
    ...
    def test_check_params_mandatory(self):
        ...
        (err, res) = req.get_and_check_params(['mandatory0', 'mandatory1', 'mandatory2'], ['optional1', 'optional2', 'optional3'])
        self.assertFalse(res)
        self.assertEqual('Empty or missing mandatory parameter(s): mandatory0', str(err))

    def test_check_params_are_on_path(self):
        req = ApiRequest(self.event_params, '0fa8fc8f-b04a-11e6-b8ed-6dda0ca82a80')
